...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/virtual/webdevng/html/test/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('/var/www/virtual/webdevng/html/test/app/cache/prod/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/var/www/virtual/webdevng/html/test/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/virtual/webdevng/html/test/app/Resources');
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'webdevng', 'user' => 'webdevng', 'password' => 'webdevng1618317515987', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_1943bd0777c2b1a972f15cd84b1a8d5f52ecb6c4848a32e36903e98f6b2f3b02');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_1943bd0777c2b1a972f15cd84b1a8d5f52ecb6c4848a32e36903e98f6b2f3b02');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_1943bd0777c2b1a972f15cd84b1a8d5f52ecb6c4848a32e36903e98f6b2f3b02');
        $d = new \Doctrine\ORM\Mapping\Driver\PHPDriver(array(0 => '/var/www/virtual/webdevng/html/test/src/Test/DemoBundle/Resources/config/doctrine', 1 => '/var/www/virtual/webdevng/html/test/src/Test/StoreBundle/Resources/config/doctrine'));
        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Test\\DemoBundle\\Entity');
        $e->addDriver($d, 'Test\\StoreBundle\\Entity');
        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('TestDemoBundle' => 'Test\\DemoBundle\\Entity', 'TestStoreBundle' => 'Test\\StoreBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/var/www/virtual/webdevng/html/test/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/virtual/webdevng/html/test/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/var/www/virtual/webdevng/html/test/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/virtual/webdevng/html/test/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/virtual/webdevng/html/test/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/virtual/webdevng/html/test/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/var/www/virtual/webdevng/html/test/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/virtual/webdevng/html/test/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/var/www/virtual/webdevng/html/test/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/virtual/webdevng/html/test/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/var/www/virtual/webdevng/html/test/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/var/www/virtual/webdevng/html/test/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/var/www/virtual/webdevng/html/test/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/var/www/virtual/webdevng/html/test/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/var/www/virtual/webdevng/html/test/src/Test/DemoBundle/Resources/views', 'TestDemo');
        $instance->addPath('/var/www/virtual/webdevng/html/test/src/Test/StoreBundle/Resources/views', 'TestStore');
        $instance->addPath('/var/www/virtual/webdevng/html/test/app/Resources/views');
        $instance->addPath('/var/www/virtual/webdevng/html/test/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        return $instance;
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/var/www/virtual/webdevng/html/test/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/virtual/webdevng/html/test/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/virtual/webdevng/html/test/app/cache/prod');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/virtual/webdevng/html/test/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/var/www/virtual/webdevng/html/test/app/cache/prod',
            'kernel.logs_dir' => '/var/www/virtual/webdevng/html/test/app/logs',
            ...
            'database_port' => NULL,
            'database_name' => 'webdevng',
            'database_user' => 'webdevng',
            'database_password' => 'webdevng1618317515987',
            ...
            'session.save_path' => '/var/www/virtual/webdevng/html/test/app/cache/prod/sessions',
            ...
            'router.resource' => '/var/www/virtual/webdevng/html/test/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/virtual/webdevng/html/test/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/var/www/virtual/webdevng/html/test/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/var/www/virtual/webdevng/html/test/app/cache/prod/assetic',
            ...
            'assetic.read_from' => '/var/www/virtual/webdevng/html/test/app/../web',
            'assetic.write_to' => '/var/www/virtual/webdevng/html/test/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/virtual/webdevng/html/test/app/cache/prod/doctrine/orm/Proxies',
